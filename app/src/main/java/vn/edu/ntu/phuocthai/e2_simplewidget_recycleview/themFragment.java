...
public class themFragment extends Fragment {
    ...
    // Khai báo các phần tử đã được đặt tên (Dùng để ánh xạ)
    ...
    info info; //khai báo 1 phần tử trong recycleview để xử lý các hàm thêm và sửa
    ...
    private void addview(View view) {
        ...
        //Thêm menu cho toolbar
        toolbar.inflateMenu(R.menu.my_menu);

        //Hàm xử lý sự kiện cho menu toolbar thứ 1
    ...
    private void addevent() {
        ...
        btnthem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                info = new info(edtngay.getText().toString(), menhgia, spinner.getSelectedItem().toString() //Lấy giá trị từ spinner
